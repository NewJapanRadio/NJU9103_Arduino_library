...
class NJU9103Class {
  public:
     ...
     *      @arg : up to 10000000
     */
    NJU9103Class(uint32_t clock = 1E6);

    ~NJU9103Class();

    /**
     * @brief Initialize the NJU9103
     */
    void begin();

    /**
     * @brief Disable the NJU9103
     */
    void end();
 ...
 * @{
 */
#define NJU9103_ADDRESS_CTRL     NJU9103Class::Address::CTRL
#define NJU9103_ADDRESS_ADCDATA0 NJU9103Class::Address::ADCDATA0
#define NJU9103_ADDRESS_ADCDATA1 NJU9103Class::Address::ADCDATA1
#define NJU9103_ADDRESS_PGACONF  NJU9103Class::Address::PGACONF
#define NJU9103_ADDRESS_CLKCONF  NJU9103Class::Address::CLKCONF
#define NJU9103_ADDRESS_DACCONF  NJU9103Class::Address::DACCONF
#define NJU9103_ADDRESS_OPTION0  NJU9103Class::Address::OPTION0
#define NJU9103_ADDRESS_OPTION1  NJU9103Class::Address::OPTION1
#define NJU9103_ADDRESS_GAIN0    NJU9103Class::Address::GAIN0
#define NJU9103_ADDRESS_GAIN1    NJU9103Class::Address::GAIN1
#define NJU9103_ADDRESS_GAIN2    NJU9103Class::Address::GAIN2
#define NJU9103_ADDRESS_OFFSET0  NJU9103Class::Address::OFFSET0
#define NJU9103_ADDRESS_OFFSET1  NJU9103Class::Address::OFFSET1
#define NJU9103_ADDRESS_OFFSET2  NJU9103Class::Address::OFFSET2
/* @} ADDRESS */
